...
// Add this include at the top of your file, after #pragma once or other includes:
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow)
{
    ...
    int nDefaultWidth = 1280*2;
    int nDefaultHeight = 720*2;
    ...
    HWND hWnd = CreateWindow(L"Direct3DWindowClass",
                             L"MD2",
                             WS_OVERLAPPEDWINDOW,
                             CW_USEDEFAULT,
                             CW_USEDEFAULT,
    ...
    g_plugin.SetWinampWindow(hWnd);
    bSuccess = g_plugin.PluginInitialize(nDefaultWidth, nDefaultHeight);
    if (!bSuccess)
        return -1;
